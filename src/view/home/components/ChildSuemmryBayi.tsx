...
const ChildSummaryImmunizationBayi: React.FC<ChildSummaryImmunizationProps> = ({
  title,
  value,
  subtitle,
  total,
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div
          className={cn(`text-2xl text-support-b2 py-2 ${classNameValue}`)}
          style={{ color: "#424242" }}
        >
          {value}
        </div>
...
export default ChildSummaryImmunizationBayi;
