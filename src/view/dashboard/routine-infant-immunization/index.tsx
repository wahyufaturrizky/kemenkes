...
const RoutineBabyImmunization = () => {
  ...
  const dataGraphRegionalRoutineImmunizationCoverageTrend2 = [
    {
      title: `Cakupan Imunisasi Bayi Lengkap`,
    ...
    },
    {
      ...
      value: (<div>{getTotalLowestScopeByVaccineTypeQuery?.data?.vaccine === "ALL" ? "Bayi Lengkap" : getTotalLowestScopeByVaccineTypeQuery?.data?.vaccine}</div>),
        ...
        <div className="flex gap-6">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm">
              ...
              <div>
                Menampilkan data cakupan imunisasi rutin bayi berdasarkan jenis imunisasi, cakupan daerah, usia pemberian, dan jenis kelamin bayi.
              </div>
            </div>
            <div className="pt-6">
            ...
            <div>
              ...
              <div className="gap-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 mt-4">
                ...
                <ChildSummaryImmunization
                  className={`px-8 ${styles.scoreCardYellow}`}
                  background="white"
                  classNameTitle="text-white" classNameValue="text-4xl text-white"
              ...
              <RoutineImmunizationCoverageTrendGraph
                ...
                graph={
                  <div className="my-4 p-4 md:p-8 border rounded-lg">
                    <GraphRoutineImmunizationCoverageTrend
                      layout="vertical"
                      title={<div className="font-bold md:text-2xl"><b className="text-primary-2">Grafik Cakupan Imunisasi pada Bayi Berdasarkan Jenis Imunisasi</b></div>}
              ...
              <RoutineImmunizationCoverageTrendGraph
                ...
                graph={
                  <div className="my-4 p-4 md:p-8 border rounded-lg">
                    <GraphRoutineImmunizationCoverageTrend
                      layout="vertical"
                      title={<div className="font-bold md:text-2xl"><b className="text-primary-2">Grafik Cakupan Imunisasi pada Bayi Berdasarkan Usia Pemberian Imunisasi</b></div>}
              ...
              <RoutineImmunizationCoverageTrendGraph
                ...
                graph={
                  <div className="my-4 p-4 md:p-8 border rounded-lg">
                    <GraphRoutineImmunizationCoverageTrend
                      layout="vertical"
                      title={<div className="font-bold md:text-2xl"><b className="text-primary-2">Grafik Distribusi Imunisasi pada Bayi Berdasarkan Jenis Kelamin</b></div>}
