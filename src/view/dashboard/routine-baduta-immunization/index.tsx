...
const RoutineBadutaImmunization = () => {
  ...
  const { data: getPercentageTotalImmunizationQuery } = useGetPercentageTotalImmunizationQuery({ ...filterQueryGraphPercentage, vaccine_type: filter.tipe_vaksin1 }, optionQuery)
  ...
  console.log(getSummaryImmunizationPerVaccineQuery?.data?.map((r: any) => r?.vaccine), "sdsdsd")
  return (
        ...
        <div className="flex gap-6">
          ...
          <div>
            <div className="flex flex-col gap-4 text-sm">
              <div className={`pt-8 ${openSans.className}`}>UPDATE TERAKHIR: 23 SEPTEMBER 2023</div>
            ...
            <div>
              ...
              <div className="gap-4 grid grid-cols-1 sm:grid-cols-3 mt-4">
                <ChildSummaryImmunization
                  ...
                  value={formatNumber(getTotalImmunizationQuery?.data?.total || 0)}
                />
                <ChildSummaryImmunization
                  ...
                  value={`${formatNumber(getDoPercentageDPHTHBHIBQuery?.data?.pct || 0)}%`}
                  percent={getDoPercentageDPHTHBHIBQuery?.data?.pct || 0}
                  target={formatNumber(getDoPercentageDPHTHBHIBQuery?.data?.target || 0)}
                  subtitle={" dari "}
                  showLine={false}
                />
                <ChildSummaryImmunization
                  ...
                  classNameValue="text-4xl text-white"
                  title={"Persentase Drop Out \nCampak Rubela"}
                  value={`${formatNumber(getDoPercentageCampakRubelaQuery?.data?.pct || 0)}%`}
                  percent={getDoPercentageCampakRubelaQuery?.data?.pct || 0}
                  target={formatNumber(getDoPercentageCampakRubelaQuery?.data?.target || 0)}
                  subtitle={" dari "}
                  showLine={false}
                />
              </div>
              <div className="gap-4 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 mt-4">
                <ChildSummaryImmunization
                  ...
                  value={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery1?.data?.total || 0)
                  }
                  percent={
                    getTotalImmunizationByVaccineTypeQuery1?.data?.pct || 0
                  }
                  target={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery1?.data?.target || 0)
                  }
                  subtitle={" dari "}
                />
                <ChildSummaryImmunization
                  ...
                  value={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery2?.data?.total || 0)
                  }
                  percent={
                    getTotalImmunizationByVaccineTypeQuery2?.data?.pct || 0
                  }
                  target={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery2?.data?.target || 0)
                  }
                  subtitle={" dari "}
                />
                <ChildSummaryImmunization
                  ...
                  value={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery3?.data?.total || 0)
                  }
                  percent={
                    getTotalImmunizationByVaccineTypeQuery3?.data?.pct || 0
                  }
                  target={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery3?.data?.target || 0)
                  }
                  subtitle={" dari "}
                />
                <ChildSummaryImmunization
                  ...
                  value={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery4?.data?.total || 0)
                  }
                  percent={
                    getTotalImmunizationByVaccineTypeQuery4?.data?.pct || 0
                  }
                  target={
                    formatNumber(getTotalImmunizationByVaccineTypeQuery4?.data?.target || 0)
                  }
                  subtitle={" dari "}
                />
              </div>
                ...
                graph={
                  <div className="my-4 p-4 md:p-8 border rounded-lg">
                    <GraphRoutineImmunizationCoverageTrend
                      title={<div className="font-bold md:text-2xl">Grafik Cakupan <b className="text-primary-2">Imunisasi Baduta Lengkap</b> pada Provinsi di <b className="text-primary-2">Indonesia</b> Selama Tahun <b className="text-primary-2">2023</b></div>}
            ...
            <div className="py-4 pb-12">
              <RoutineImmunizationCoverageTrendGraph
                ...
                graph={
                  <div className="my-4 p-4 md:p-8 border rounded-lg">
                    <GraphRoutineImmunizationCoverageTrend
                      title={<div className="font-bold md:text-2xl">Data Kumulatif Jumlah Penerima, Cakupan, dan Target Cakupan <b className="text-primary-2">Imunisasi Baduta Lengkap</b> pada Baduta Selama Tahun <b className="text-primary-2">2023</b></div>}
