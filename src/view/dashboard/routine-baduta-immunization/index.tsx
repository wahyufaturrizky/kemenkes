      ...
      <div className="container px-4">
        <div className="flex gap-6">
          ...
          <div>
            ...
            <div>
              <div className="text-xl md:text-3xl text-primary-2 font-bold">Ringkasan Data Cakupan Imunisasi Rutin Baduta</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                ...
                {dataTotalSummaryImmunizationTotal.slice(0, 2)?.map((r, i) => (
                  <ChildSummaryImmunization key={i} {...r} className="border rounded-lg px-4" background="#FAC515" classNameTitle="text-white" classNameValue="text-4xl text-white" />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-4">
                ...
                {dataTotalSummaryImmunization.slice(0, 3)?.map((r, i) => (
