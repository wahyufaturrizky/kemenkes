...
const CardPemeriksaanPTM: React.FC<card> = ({
  label,
  value,
  pct,
  data,
  ...
  return (
    <div
        className="col-span-6 lg:col-span-4 rounded-2xl max-h-[800px] min-h-[420px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-[34px] flex flex-col justify-between"
        id="card-pemeriksaan-ptm"
    >
      <div>
        <p className="font-semibold text-xl" id="card-pemeriksaan-ptm-label">{label}</p>
        {subLabel && <p className="font-medium text-sm italic text-[#616161]" id="card-pemeriksaan-ptm-subLabel">{subLabel}</p>}
...
export default CardPemeriksaanPTM;
